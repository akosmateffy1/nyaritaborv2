...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      $message[] = 'felhasználó már létezik'; 
   }else{
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `user_form`(name, email, password, image) VALUES('$name', '$email', '$pass', '$image')") or die('a lekérdezés sikertelen');
